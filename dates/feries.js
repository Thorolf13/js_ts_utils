...
function calcJoursFeries(annee) {
    // jours fixes
 ...
 */
export function isJourOuvrable(date) {
    date = new Date(date);
 ...
 */
export function addJourOuvrable(date, nb) {
 ...
 */
export function addJourOuvre(date, nb) {
    let newDate = new Date(date);
    const sub = nb < 0;
    nb = Math.abs(nb);
    while (nb > 0) {
